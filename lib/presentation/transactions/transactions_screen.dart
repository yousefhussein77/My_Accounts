          ...
          data: (data) {
            ...
            return ListView(
              ...
              children: [
                const AppHeader(
                  title: 'العمليات',
                  subtitle: 'كل عملة لها سجلها بدون خلط الحسابات.',
                ),
                ...
                if (data.transactions.isEmpty)
                  ...
                  AppEmptyState(
                    ...
                    title: 'لا توجد عمليات ${_selectedCurrency!.label}',
                    message: 'أضف عملية بهذه العملة أو اعرض كل العملات.',
                  )
                else
                  ...transactions.map((tx) {
